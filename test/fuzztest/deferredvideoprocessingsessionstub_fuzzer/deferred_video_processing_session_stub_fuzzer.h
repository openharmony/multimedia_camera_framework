...
public:
    ...
    int32_t AddVideo(
        const std::string& videoId,
        const std::vector<sptr<IPCFileDescriptor>>& fds) override
    {
        return 0;
    }
    int32_t RemoveVideo(
...
public:
static std::shared_ptr<DeferredVideoProcessingSessionStubFuzz> fuzz_;
