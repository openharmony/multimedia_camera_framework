...
#include "command_server_impl_fuzzer.h"
...
void CommandServerImplFuzzer::CommandServerImplFuzzTest()
{
...
void Test()
{
    auto commandServerImpl = std::make_unique<CommandServerImplFuzzer>();
    if (commandServerImpl == nullptr) {
        MEDIA_INFO_LOG("commandServerImpl is null");
        return;
    }
    commandServerImpl->CommandServerImplFuzzTest();
}
