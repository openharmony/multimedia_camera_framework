...
class MockStreamMetadataCallback : public StreamMetadataCallbackStub {
public:
    ErrCode OnMetadataResult(int32_t streamId, const std::shared_ptr<CameraMetadata>& results) override
    {
        return 0;
    }
};
