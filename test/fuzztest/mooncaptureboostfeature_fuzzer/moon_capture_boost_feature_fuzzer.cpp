...
#include "moon_capture_boost_feature_fuzzer.h"
...
void MoonCaptureBoostFeatureFuzzer::MoonCaptureBoostFeatureFuzzTest()
{
...
void Test()
{
    auto moonCaptureBoostFeature = std::make_unique<MoonCaptureBoostFeatureFuzzer>();
    if (moonCaptureBoostFeature == nullptr) {
        MEDIA_INFO_LOG("moonCaptureBoostFeature is null");
        return;
    }
    moonCaptureBoostFeature->MoonCaptureBoostFeatureFuzzTest();
}
