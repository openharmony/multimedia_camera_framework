...
HStreamDepthDataStubFuzz *HStreamDepthDataStubFuzzer::fuzz_ = nullptr;
...
void HStreamDepthDataStubFuzzer::OnRemoteRequest(int32_t code)
{
    if ((RAW_DATA == nullptr) || (g_dataSize > MAX_CODE_LEN) || (g_dataSize < MIN_SIZE_NUM)) {
        return;
    }
    if (fuzz_ == nullptr) {
        fuzz_ = new HStreamDepthDataStubFuzz();
    }
    MessageParcel reply;
