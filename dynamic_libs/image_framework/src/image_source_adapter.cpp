    ...
    uint32_t& errorCode)
{
    ...
    CHECK_RETURN_RET_ELOG(imageSource_ == nullptr, -1, "CreateImageSource failed");
    return 0;
}
    ...
    uint32_t& errorCode)
{
    ...
    CHECK_RETURN_RET_ELOG(imageSource_ == nullptr, nullptr, "imageSource_ is nullptr");
    std::unique_ptr<Media::PixelMap> pixelMap = imageSource_->CreatePixelMap(opts, errorCode);
    CHECK_RETURN_RET_ELOG(pixelMap == nullptr, nullptr, "CreatePixelMap failed");
    return pixelMap;
}
