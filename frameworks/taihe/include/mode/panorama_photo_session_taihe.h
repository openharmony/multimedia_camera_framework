...
#ifndef FRAMEWORKS_TAIHE_INCLUDE_PANORAMA_PHOTO_SESSION_TAIHE_H
#define FRAMEWORKS_TAIHE_INCLUDE_PANORAMA_PHOTO_SESSION_TAIHE_H
...
public:
    ...
    ~PanoramaPhotoSessionImpl() = default;
private:
    sptr<OHOS::CameraStandard::PanoramaSession> panoramaSession_ = nullptr;
};
} // namespace Camera
} // namespace Ani

#endif // FRAMEWORKS_TAIHE_INCLUDE_PANORAMA_PHOTO_SESSION_TAIHE_H