...
public:
    ...
    ~MacroPhotoSessionImpl() = default;
private:
    sptr<OHOS::CameraStandard::MacroPhotoSession> macroPhotoSession_ = nullptr;
};
} // namespace Camera
} // namespace Ani

#endif // FRAMEWORKS_TAIHE_INCLUDE_MACRO_PHOTO_SESSION_TAIHE_H