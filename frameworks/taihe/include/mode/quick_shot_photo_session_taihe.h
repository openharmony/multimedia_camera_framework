...
#ifndef FRAMEWORKS_TAIHE_INCLUDE_QUICK_SHOT_PHOTO_SESSION_TAIHE_H
#define FRAMEWORKS_TAIHE_INCLUDE_QUICK_SHOT_PHOTO_SESSION_TAIHE_H
...
public:
    ...
    ~QuickShotPhotoSessionImpl() = default;
private:
    sptr<OHOS::CameraStandard::QuickShotPhotoSession> quickShotPhotoSession_ = nullptr;
};
} // namespace Camera
} // namespace Ani

#endif // FRAMEWORKS_TAIHE_INCLUDE_QUICK_SHOT_PHOTO_SESSION_TAIHE_H