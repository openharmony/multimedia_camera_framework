...
{
    CHECK_ERROR_RETURN_RET_LOG(nightSession_ == nullptr, -1, "GetExposure failed, nightSession_ is nullptr!");
    uint32_t exposure;
...
{
    CHECK_ERROR_RETURN_LOG(nightSession_ == nullptr, "SetExposure failed, nightSession_ is nullptr!");
...
{
    CHECK_ERROR_RETURN_RET_LOG(nightSession_ == nullptr, {},
