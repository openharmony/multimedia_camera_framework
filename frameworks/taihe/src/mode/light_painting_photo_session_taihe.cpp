...
array<LightPaintingType> LightPaintingPhotoSessionImpl::GetSupportedLightPaintingTypes()
{
    ...
    CHECK_ERROR_RETURN_RET_LOG(!CameraUtilsTaihe::CheckError(retCode), array<LightPaintingType>(nullptr, 0),
...
void LightPaintingPhotoSessionImpl::SetLightPaintingType(LightPaintingType type)
{
    ...
    CHECK_ERROR_RETURN_LOG(!CameraUtilsTaihe::CheckError(retCode), "SetLightPainting fail %{public}d", retCode);
}
...
LightPaintingType LightPaintingPhotoSessionImpl::GetLightPaintingType()
{
    ...
    CHECK_ERROR_PRINT_LOG(!CameraUtilsTaihe::CheckError(retCode), "GetLightPainting fail %{public}d", retCode);
