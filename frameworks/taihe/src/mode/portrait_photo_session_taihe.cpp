    ...
    CameraOutputCapability const& outputCapability)
{
    ...
    CHECK_ERROR_RETURN_RET_LOG(portraitSession_ == nullptr, {}, "portraitSession_ is nullptr");
...
{
    CHECK_ERROR_RETURN_RET_LOG(portraitSession_ == nullptr, array<PortraitEffect>(nullptr, 0),
...
void PortraitPhotoSessionImpl::SetPortraitEffect(PortraitEffect effect)
{
    ...
    CHECK_ERROR_RETURN_LOG(portraitSession_ == nullptr, "SetPortraitEffect portraitSession_ is null");
...
PortraitEffect PortraitPhotoSessionImpl::GetPortraitEffect()
{
    ...
    CHECK_ERROR_RETURN_RET_LOG(portraitSession_ == nullptr, errType, "GetPortraitEffect portraitSession_ is null");
