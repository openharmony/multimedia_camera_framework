...
using GetNativeImageFn = bool (*)(void*, std::shared_ptr<OHOS::Media::NativeImage>&, bool&);
...
CameraInput CameraInputTransferStaticImpl(uintptr_t input)
{
    ...
    CHECK_RETURN_RET_ELOG(!arkts_esvalue_unwrap(get_env(), esValue, &nativePtr) || nativePtr == nullptr,
        cameraInputTH, "%{public}s unwrap esValue failed", __func__);
    GetNativeCameraInputFn funcHandle = nullptr;
    CHECK_RETURN_RET_ELOG(!LibManager::GetSymbol("GetNativeCameraInput", funcHandle),
    ...
    CHECK_RETURN_RET_ELOG(!ret || nativeCameraInput == nullptr,
...
{
    MEDIA_INFO_LOG("%{public}s Called", __func__);
    CHECK_RETURN_RET_ELOG(input.is_error(), 0, "%{public}s input is nullptr", __func__);
    CameraInputImpl *implPtr = reinterpret_cast<CameraInputImpl*>(input->GetSpecificImplPtr());
    CHECK_RETURN_RET_ELOG(implPtr == nullptr, 0, "%{public}s implPtr is nullptr", __func__);
    napi_env jsEnv;
    CHECK_RETURN_RET_ELOG(!arkts_napi_scope_open(get_env(), &jsEnv), 0,
...
PhotoOutput PhotoOutputTransferStaticImpl(uintptr_t input)
{
    ...
    CHECK_RETURN_RET_ELOG(!LibManager::GetSymbol("GetNativePhotoOutput", funcHandle),
    ...
    CHECK_RETURN_RET_ELOG(!ret || nativePhotoOutput == nullptr,
...
PreviewOutput PreviewOutputTransferStaticImpl(uintptr_t input)
{
    ...
    CHECK_RETURN_RET_ELOG(!LibManager::GetSymbol("GetNativePreviewOutput", funcHandle),
    ...
    CHECK_RETURN_RET_ELOG(!ret || nativePreviewOutput == nullptr,
...
VideoOutput VideoOutputTransferStaticImpl(uintptr_t input)
{
    ...
    CHECK_RETURN_RET_ELOG(!LibManager::GetSymbol("GetNativeVideoOutput", funcHandle),
    ...
    CHECK_RETURN_RET_ELOG(!ret || nativeVideoOutput == nullptr,
...
MetadataOutput MetadataOutputTransferStaticImpl(uintptr_t input)
{
    ...
    CHECK_RETURN_RET_ELOG(!LibManager::GetSymbol("GetNativeMetadataOutput", funcHandle),
    ...
    CHECK_RETURN_RET_ELOG(!ret || nativeMetadataOutput == nullptr,
...
VideoSession VideoSessionTransferStaticImpl(uintptr_t input)
{
    ...
    CHECK_RETURN_RET_ELOG(!LibManager::GetSymbol("GetNativeVideoSession", funcHandle),
    ...
    CHECK_RETURN_RET_ELOG(!ret || session == nullptr,
...
uintptr_t VideoSessionTransferDynamicImpl(weak::VideoSession input)
{
    ...
    napi_value instance = funcHandle(jsEnv,
        static_cast<OHOS::CameraStandard::VideoSession*>((implPtr->GetVideoSession().GetRefPtr())));
    if (instance == nullptr) {
        MEDIA_ERR_LOG("%{public}s Get GetVideoSessionNapi symbol failed", __func__);
        arkts_napi_scope_close_n(jsEnv, 0, nullptr, nullptr);
        return 0;
...
SecureSession SecureSessionTransferStaticImpl(uintptr_t input)
{
    ...
    CHECK_RETURN_RET_ELOG(!LibManager::GetSymbol("GetNativeSecureCameraSession", funcHandle),
...
PhotoSession PhotoSessionTransferStaticImpl(uintptr_t input)
{
    ...
    CHECK_RETURN_RET_ELOG(!LibManager::GetSymbol("GetNativePhotoSession", funcHandle),
...
uintptr_t PhotoSessionTransferDynamicImpl(weak::PhotoSession input)
{
    ...
    napi_value instance = funcHandle(jsEnv,
        static_cast<OHOS::CameraStandard::PhotoSession*>((implPtr->GetPhotoSession().GetRefPtr())));
    if (instance == nullptr) {
        MEDIA_ERR_LOG("%{public}s Get GetPhotoSessionNapi symbol failed", __func__);
        arkts_napi_scope_close_n(jsEnv, 0, nullptr, nullptr);
        return 0;
...
uintptr_t PhotoTransferDynamicImpl(weak::Photo input)
{
    ...
    CHECK_RETURN_RET_ELOG(photoImplPtr == nullptr, 0, "%{public}s photoImplPtr is nullptr", __func__);
    bool isRaw = false;
    std::shared_ptr<OHOS::Media::NativeImage> nativeImage = GetNativeImageFromTH(photoImplPtr, isRaw);
    CHECK_RETURN_RET_ELOG(nativeImage == nullptr, 0, "%{public}s GetNativeImageFromTH failed", __func__);
    napi_env jsEnv;
    CHECK_RETURN_RET_ELOG(!arkts_napi_scope_open(get_env(), &jsEnv), 0,
        "%{public}s arkts_napi_scope_open failed", __func__);
