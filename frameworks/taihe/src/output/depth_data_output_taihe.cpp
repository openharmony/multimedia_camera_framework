    ...
    std::shared_ptr<uintptr_t> callback, bool isOnce)
{
    ...
    if (depthDataListener_ == nullptr) {
        ...
        CHECK_ERROR_PRINT_LOG(ret != OHOS::SURFACE_ERROR_OK, "register surface consumer listener failed!");
...
void DepthDataTaiheListener::OnBufferAvailableCallback() const
{
    ...
    CHECK_ERROR_RETURN_LOG(!depthDataSurface_, "depthDataSurface_ is null");
    ...
    CHECK_ERROR_RETURN_LOG(surfaceRet != OHOS::SURFACE_ERROR_OK, "Failed to acquire surface buffer");
...
void DepthDataTaiheListener::ExecuteDepthData(OHOS::sptr<OHOS::SurfaceBuffer> surfaceBuffer) const
{
    ...
    CHECK_ERROR_RETURN_LOG(!depthProfile_, "depthProfile_ is null");
    ...
    CHECK_ERROR_RETURN_LOG(!surfaceBuffer, "surfaceBuffer is null");
