...
{
    CHECK_ERROR_RETURN_LOG(metadataOutputCallback_ == nullptr, "ErrorCallback is null");
...
{
    CHECK_ERROR_RETURN_LOG(metadataObjectsAvailableCallback_ == nullptr, "metadataOutputCallback is null");
