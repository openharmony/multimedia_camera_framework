...
{
    MEDIA_DEBUG_LOG("CameraMuteListenerNapi::OnCameraMuteCallback called, muteMode: %{public}d", muteMode);
    ...
    MEDIA_DEBUG_LOG("CameraMuteListenerNapi::OnCameraMuteCallback napi_call_function end");
}
