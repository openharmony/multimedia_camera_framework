...
napi_value CameraNapi::Init(napi_env env, napi_value exports)
{
    ...
    napi_property_descriptor camera_static_prop[] = {
        ...
        DECLARE_NAPI_PROPERTY("SensorColorFilterArrangement", CreateObjectWithMap(env, "SensorColorFilterArrangement",
...
{
    CAMERA_SYNC_TRACE;
    MEDIA_DEBUG_LOG("CreateCameraManagerInstance is called");
    napi_value result = nullptr;
