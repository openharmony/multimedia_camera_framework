...
napi_value VideoSessionForSysNapi::Init(napi_env env, napi_value exports)
{
    ...
    std::vector<std::vector<napi_property_descriptor>> descriptors = {camera_process_props, flash_props,
        auto_exposure_props, focus_props, zoom_props, filter_props, beauty_props, color_effect_props,
        quality_prioritization_props, macro_props, color_management_props, stabilization_props, preconfig_props,
        camera_output_capability_props, camera_ability_props, aperture_props, color_reservation_props,
        effect_suggestion_props};
