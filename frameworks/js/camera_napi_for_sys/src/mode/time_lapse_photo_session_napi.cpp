...
void TryAEInfoNapi::Init(napi_env env)
{
    ...
    CHECK_ERROR_RETURN_LOG(status != napi_ok, "TryAEInfoNapi defined class failed");
    int32_t refCount = 1;
    status = napi_create_reference(env, ctorObj, refCount, &sConstructor_);
    CHECK_ERROR_RETURN_LOG(status != napi_ok, "TryAEInfoNapi Init failed");
...
napi_value TryAEInfoNapi::IsTryAEDone(napi_env env, napi_callback_info info)
{
    ...
    CHECK_ERROR_RETURN_RET_LOG(obj == nullptr || obj->tryAEInfo_ == nullptr, nullptr,
...
void TimeLapsePhotoSessionNapi::Init(napi_env env)
{
    ...
    CHECK_ERROR_RETURN_LOG(status != napi_ok, "TimeLapsePhotoSessionNapi defined class failed");
    int32_t refCount = 1;
    status = napi_create_reference(env, ctorObj, refCount, &sConstructor_);
    CHECK_ERROR_RETURN_LOG(status != napi_ok, "TimeLapsePhotoSessionNapi Init failed");
...
napi_value TimeLapsePhotoSessionNapi::IsTryAENeeded(napi_env env, napi_callback_info info)
{
    ...
    CHECK_ERROR_RETURN_RET_LOG(obj == nullptr, nullptr, "%{public}s: Unwrap Napi Object Failed", __FUNCTION__);
    bool needed;
    ...
    napi_value result;
    CHECK_ERROR_PRINT_LOG(napi_get_boolean(env, ret, &result) != napi_ok,
...
napi_value TimeLapsePhotoSessionNapi::GetTimeLapseInterval(napi_env env, napi_callback_info info)
{
    ...
    napi_value result;
    CHECK_ERROR_PRINT_LOG(napi_create_int32(env, interval, &result) != napi_ok,
...
napi_value TimeLapsePhotoSessionNapi::SetTimeLapseInterval(napi_env env, napi_callback_info info)
{
    ...
    CHECK_ERROR_RETURN_RET_LOG(!parser.AssertStatus(INVALID_ARGUMENT, "Invalid argument!"), nullptr,
...
napi_value TimeLapsePhotoSessionNapi::GetExposure(napi_env env, napi_callback_info info)
{
    ...
    CAMERA_NAPI_GET_JS_OBJ_WITH_ZERO_ARGS(env, info, status, thisVar);
    TimeLapsePhotoSessionNapi* obj = Unwrap<TimeLapsePhotoSessionNapi>(env, thisVar);
    CHECK_ERROR_RETURN_RET_LOG(obj == nullptr, nullptr,
        "%{public}s: Unwrap Napi Object Failed", __FUNCTION__);
    uint32_t exposure;
    ...
    napi_value result;
    CHECK_ERROR_PRINT_LOG(napi_create_uint32(env, exposure, &result) != napi_ok,
...
napi_value TimeLapsePhotoSessionNapi::SetExposure(napi_env env, napi_callback_info info)
{
    ...
    CHECK_ERROR_RETURN_RET_LOG(!parser.AssertStatus(INVALID_ARGUMENT, "Invalid argument!"),
...
napi_value TimeLapsePhotoSessionNapi::IsExposureMeteringModeSupported(napi_env env, napi_callback_info info)
{
    ...
    napi_value result;
    CHECK_ERROR_PRINT_LOG(napi_get_boolean(env, supported, &result) != napi_ok,
        "%{public}s: Napi Get Boolean Failed", __FUNCTION__);
    return result;
}
...
napi_value TimeLapsePhotoSessionNapi::GetExposureMeteringMode(napi_env env, napi_callback_info info)
{
    ...
    napi_value result;
    CHECK_ERROR_PRINT_LOG(napi_create_int32(env, static_cast<int32_t>(mode), &result) != napi_ok,
        "%{public}s: Napi Create Int32 Failed", __FUNCTION__);
    return result;
}
...
napi_value TimeLapsePhotoSessionNapi::GetIso(napi_env env, napi_callback_info info)
{
    ...
    CAMERA_NAPI_GET_JS_OBJ_WITH_ZERO_ARGS(env, info, status, thisVar);
    TimeLapsePhotoSessionNapi* obj = Unwrap<TimeLapsePhotoSessionNapi>(env, thisVar);
    CHECK_ERROR_RETURN_RET_LOG(obj == nullptr,
        nullptr, "%{public}s: Unwrap Napi Object Failed", __FUNCTION__);
    int32_t iso;
    ...
    napi_value result;
    CHECK_ERROR_PRINT_LOG(napi_create_int32(env, iso, &result) != napi_ok,
        "%{public}s: Napi Create Int32 Failed", __FUNCTION__);
    return result;
}
...
napi_value TimeLapsePhotoSessionNapi::SetIso(napi_env env, napi_callback_info info)
{
    ...
    obj->timeLapsePhotoSession_->UnlockForControl();
    CHECK_ERROR_RETURN_RET_LOG(ret != CameraErrorCode::SUCCESS, nullptr, "%{public}s: setIso() Failed", __FUNCTION__);
    napi_value result;
    napi_get_undefined(env, &result);
    return result;
}
...
napi_value TimeLapsePhotoSessionNapi::GetWhiteBalance(napi_env env, napi_callback_info info)
{
    ...
    napi_value result;
    CHECK_ERROR_PRINT_LOG(napi_create_int32(env, balance, &result) != napi_ok,
        "%{public}s: Napi Create Int32 Failed", __FUNCTION__);
    return result;
}
...
napi_value TimeLapsePhotoSessionNapi::Constructor(napi_env env, napi_callback_info info)
{
    ...
    if (status == napi_ok && thisVar != nullptr) {
        ...
        obj->env_ = env;
        CHECK_ERROR_RETURN_RET_LOG(sCameraSessionForSys_ == nullptr, nullptr, "sCameraSessionForSys_ is null");
        ...
        CHECK_ERROR_RETURN_RET_LOG(obj->timeLapsePhotoSession_ == nullptr, nullptr,
