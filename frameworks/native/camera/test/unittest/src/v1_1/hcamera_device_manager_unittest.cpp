...
/*
 * Feature: Framework
 * Function: Test RemoveDevice abnormal branches while camera device holder is empty.
 * SubFunction: NA
 * FunctionPoints: NA
 * EnvConditions: NA
 * CaseDescription: Test RemoveDevice abnormal branches while camera device holder is empty.
 */
...
/*
 * Feature: Framework
 * Function: Test GetConflictDevices normal branches while camera device holder is empty.
 * SubFunction: NA
 * FunctionPoints: NA
 * EnvConditions: NA
 * CaseDescription: Test RemoveDevice abnormal branches while camera device holder is empty.
 ...
 */
HWTEST_F(HCameraDeviceManagerUnitTest, hcamera_device_manager_unittest_004, TestSize.Level0)
{
 ...
 */
HWTEST_F(HCameraDeviceManagerUnitTest, hcamera_device_manager_unittest_005, TestSize.Level0)
{
