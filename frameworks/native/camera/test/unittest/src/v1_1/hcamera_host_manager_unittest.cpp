 ...
 */
HWTEST_F(HCameraHostManagerUnitTest, Prelaunch_001, TestSize.Level0)
{
    sptr<HCameraHostManager> cameraHostManager = new HCameraHostManager(nullptr);
 ...
 */
HWTEST_F(HCameraHostManagerUnitTest, AddCameraDevice_001, TestSize.Level0)
{
 ...
 */
HWTEST_F(HCameraHostManagerUnitTest, Init_001, TestSize.Level0)
{
    std::vector<sptr<CameraDevice>> cameras = cameraManager->GetSupportedCameras();
    ASSERT_NE(cameras.size(), 0);
    sptr<CaptureInput> input = cameraManager->CreateCameraInput(cameras[0]);
 ...
 */
HWTEST_F(HCameraHostManagerUnitTest, HCameraHostManager_001, TestSize.Level0)
{
    std::vector<sptr<CameraDevice>> cameras = cameraManager->GetSupportedCameras();
    ASSERT_NE(cameras.size(), 0);
    sptr<CaptureInput> input = cameraManager->CreateCameraInput(cameras[0]);
