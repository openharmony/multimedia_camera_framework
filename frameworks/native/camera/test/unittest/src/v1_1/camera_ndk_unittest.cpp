 ...
 */
HWTEST_F(CameraNdkUnitTest, Camera_ResultCallback_unittest, TestSize.Level0)
{
...
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_020, TestSize.Level0)
{
    ...
    SessionControlParams(captureSession);
