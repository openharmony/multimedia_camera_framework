...
public:
    int32_t streams[82] = {
        CameraNdkUnitTest::DEFAULT_MODE, CameraNdkUnitTest::PREVIEW_STREAM,
        OHOS_CAMERA_FORMAT_YCRCB_420_SP, CameraNdkUnitTest::PREVIEW_DEFAULT_WIDTH,
        CameraNdkUnitTest::PREVIEW_DEFAULT_HEIGHT, CameraNdkUnitTest::PREVIEW_FRAMERATE,
        CameraNdkUnitTest::MIN_FRAMERATE, CameraNdkUnitTest::MAX_FRAMERATE,
        CameraNdkUnitTest::ABILITY_FINISH, CameraNdkUnitTest::STREAM_FINISH,
        CameraNdkUnitTest::VIDEO_STREAM, OHOS_CAMERA_FORMAT_YCRCB_420_SP,
        CameraNdkUnitTest::VIDEO_DEFAULT_WIDTH, CameraNdkUnitTest::VIDEO_DEFAULT_HEIGHT,
        CameraNdkUnitTest::VIDEO_FRAMERATE, CameraNdkUnitTest::MIN_FRAMERATE,
        CameraNdkUnitTest::MAX_FRAMERATE, CameraNdkUnitTest::ABILITY_FINISH,
        CameraNdkUnitTest::STREAM_FINISH, CameraNdkUnitTest::PHOTO_STREAM,
        OHOS_CAMERA_FORMAT_JPEG, CameraNdkUnitTest::PHOTO_DEFAULT_WIDTH,
        CameraNdkUnitTest::PHOTO_DEFAULT_HEIGHT, CameraNdkUnitTest::PHOTO_FRAMERATE,
        CameraNdkUnitTest::MIN_FRAMERATE, CameraNdkUnitTest::MAX_FRAMERATE,
        CameraNdkUnitTest::ABILITY_FINISH, CameraNdkUnitTest::STREAM_FINISH,
        CameraNdkUnitTest::MODE_FINISH, CameraNdkUnitTest::PORTRAIT_MODE,
        CameraNdkUnitTest::PREVIEW_STREAM, OHOS_CAMERA_FORMAT_YCRCB_420_SP,
        CameraNdkUnitTest::PREVIEW_DEFAULT_WIDTH, CameraNdkUnitTest::PREVIEW_DEFAULT_HEIGHT,
        CameraNdkUnitTest::PREVIEW_FRAMERATE, CameraNdkUnitTest::MIN_FRAMERATE,
        CameraNdkUnitTest::MAX_FRAMERATE, CameraNdkUnitTest::ABILITY_ID_ONE,
        CameraNdkUnitTest::ABILITY_ID_TWO, CameraNdkUnitTest::ABILITY_ID_THREE,
        CameraNdkUnitTest::ABILITY_ID_FOUR, CameraNdkUnitTest::ABILITY_FINISH,
        CameraNdkUnitTest::STREAM_FINISH, CameraNdkUnitTest::VIDEO_STREAM, OHOS_CAMERA_FORMAT_YCRCB_420_SP,
        CameraNdkUnitTest::VIDEO_DEFAULT_WIDTH, CameraNdkUnitTest::VIDEO_DEFAULT_HEIGHT,
        CameraNdkUnitTest::VIDEO_FRAMERATE, CameraNdkUnitTest::MIN_FRAMERATE,
        CameraNdkUnitTest::MAX_FRAMERATE, CameraNdkUnitTest::ABILITY_ID_ONE,
        CameraNdkUnitTest::ABILITY_ID_TWO, CameraNdkUnitTest::ABILITY_ID_THREE,
        ...
        CameraNdkUnitTest::PHOTO_DEFAULT_HEIGHT, CameraNdkUnitTest::PHOTO_FRAMERATE,
        CameraNdkUnitTest::MIN_FRAMERATE, CameraNdkUnitTest::MAX_FRAMERATE,
        CameraNdkUnitTest::ABILITY_ID_ONE, CameraNdkUnitTest::ABILITY_ID_TWO,
        CameraNdkUnitTest::ABILITY_ID_THREE, CameraNdkUnitTest::ABILITY_ID_FOUR,
        CameraNdkUnitTest::ABILITY_FINISH, CameraNdkUnitTest::STREAM_FINISH,
        CameraNdkUnitTest::MODE_FINISH
    };
    int32_t modes[2] = {0, 1};
    ...
    explicit MockHCameraHostManager(StatusCallback* statusCallback) : HCameraHostManager(statusCallback)
    {
        ...
        ON_CALL(*this, GetCameraAbility).WillByDefault([this](std::string &cameraId,
            ...
            int32_t activeArraySize[] = {
                0, 0, CameraNdkUnitTest::PREVIEW_DEFAULT_WIDTH, CameraNdkUnitTest::PREVIEW_DEFAULT_HEIGHT
            };
...
Camera_PhotoOutput* CameraNdkUnitTest::CreatePhotoOutput(int32_t width, int32_t height)
{
    ...
    surfaceIdStr.assign(surfaceId);
    Camera_PhotoOutput* photoOutput;
    OH_CameraManager_CreatePhotoOutput(cameraManager, &photoProfile, surfaceId, &photoOutput);
    return photoOutput;
}
#ifdef YSH_CLOSE
sptr<CaptureOutput> CameraNdkUnitTest::CreatePreviewOutput(int32_t width, int32_t height)
{
...
sptr<CaptureOutput> CameraNdkUnitTest::CreateVideoOutput(int32_t width, int32_t height)
{
    sptr<Surface> surface = Surface::CreateSurfaceAsConsumer();
    if (surface == nullptr) {
        return nullptr;
...
#endif
#ifdef YSH_CLOSE
void CameraNdkUnitTest::SessionCommit(sptr<CaptureSession> session)
{
...
void CameraNdkUnitTest::SessionControlParams(sptr<CaptureSession> session)
{
...
void CameraNdkUnitTest::PortraitSessionControlParams(sptr<PortraitSession> portraitSession)
{
...
void CameraNdkUnitTest::PortraitSessionEffectParams(sptr<PortraitSession> portraitSession)
{
    std::vector<PortraitEffect> effects= portraitSession->GetSupportedPortraitEffects();
    ASSERT_TRUE(effects.size() != 0);
...
void CameraNdkUnitTest::PortraitSessionFilterParams(sptr<PortraitSession> portraitSession)
{
    std::vector<FilterType> filterLists= portraitSession->GetSupportedFilters();
    ASSERT_TRUE(filterLists.size() != 0);
...
void CameraNdkUnitTest::PortraitSessionBeautyParams(sptr<PortraitSession> portraitSession)
{
    std::vector<BeautyType> beautyLists= portraitSession->GetSupportedBeautyTypes();
    ASSERT_TRUE(beautyLists.size() != 0);
...
void CameraNdkUnitTest::SetUp()
{
    ...
    OH_Camera_GetCameraMananger(&cameraManager);
    OH_CameraManager_GetSupportedCameras(cameraManager, &cameraDevice, &cameraDeviceSize);
    ASSERT_NE(cameraDeviceSize, 0);
 ...
 */
HWTEST_F(CameraNdkUnitTest, CameraInput_unittest, TestSize.Level0)
{
    Camera_Input *cameraInput;
    OH_CameraManager_CreateCameraInput(cameraManager, cameraDevice, &cameraInput);
    ASSERT_NE(&cameraInput, nullptr);
    Camera_ErrorCode ret = CAMERA_OK;
    CameraInput_Callbacks *setResultCallback = new CameraInput_Callbacks;
    ret = OH_CameraInput_RegisterCallback(cameraInput, setResultCallback);
    ...
    ASSERT_EQ(ret, CAMERA_OK);
    ret = OH_CameraInput_UnregisterCallback(cameraInput, setResultCallback);
    ASSERT_EQ(ret, CAMERA_OK);
    delete setResultCallback;
}
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_003, TestSize.Level0)
{
    Camera_CaptureSession *session;
    Camera_ErrorCode ret = OH_CameraManager_CreateCaptureSession(cameraManager, &session);
    ASSERT_EQ(ret, CAMERA_OK);
...
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_004, TestSize.Level0)
{
    ...
    Camera_Format format = (Camera_Format)CAMERA_FORMAT_YUV_420_SP;
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_005, TestSize.Level0)
{
    int32_t width = PREVIEW_DEFAULT_WIDTH;
    int32_t height = PREVIEW_DEFAULT_HEIGHT;
    Camera_Size previewSize = {
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_011, TestSize.Level0)
{
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_012, TestSize.Level0)
{
    int32_t width = PHOTO_DEFAULT_WIDTH;
    int32_t height = PHOTO_DEFAULT_HEIGHT;
    Camera_Size photoSize = {
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_015, TestSize.Level0)
{
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_016, TestSize.Level0)
{
    int32_t width = VIDEO_DEFAULT_WIDTH;
    int32_t height = VIDEO_DEFAULT_HEIGHT;
    Camera_Size videoSize = {
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_020, TestSize.Level0)
{
    sptr<Camera_PhotoOutput> photo = CreatePhotoOutput();
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_021, TestSize.Level0)
{
    InSequence s;
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_022, TestSize.Level0)
{
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_023, TestSize.Level0)
{
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_024, TestSize.Level0)
{
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_025, TestSize.Level0)
{
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_026, TestSize.Level0)
{
    sptr<CaptureSession> session = cameraManager->CreateCaptureSession();
    ASSERT_NE(session, nullptr);
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_032, TestSize.Level0)
{
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_034, TestSize.Level0)
{
    sptr<CaptureSession> session = cameraManager->CreateCaptureSession();
    ASSERT_NE(session, nullptr);
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_035, TestSize.Level0)
{
    sptr<CaptureSession> session = cameraManager->CreateCaptureSession();
    ASSERT_NE(session, nullptr);
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_040, TestSize.Level0)
{
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_046, TestSize.Level0)
{
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
    std::vector<sptr<CameraDevice>> cameras = cameraManager->GetSupportedCameras();
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_047, TestSize.Level0)
{
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    std::vector<sptr<CameraDevice>> cameras = cameraManager->GetSupportedCameras();
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_048, TestSize.Level0)
{
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    std::vector<sptr<CameraDevice>> cameras = cameraManager->GetSupportedCameras();
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_049, TestSize.Level0)
{
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    std::vector<sptr<CameraDevice>> cameras = cameraManager->GetSupportedCameras();
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_050, TestSize.Level0)
{
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
    std::vector<sptr<CameraDevice>> cameras = cameraManager->GetSupportedCameras();
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_051, TestSize.Level0)
{
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
    std::vector<sptr<CameraDevice>> cameras = cameraManager->GetSupportedCameras();
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_unittest_052, TestSize.Level0)
{
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
    std::vector<sptr<CameraDevice>> cameras = cameraManager->GetSupportedCameras();
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_001, TestSize.Level0)
{
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_002, TestSize.Level0)
{
    InSequence s;
    std::vector<sptr<CameraDevice>> cameras = cameraManager->GetSupportedCameras();
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_003, TestSize.Level0)
{
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_004, TestSize.Level0)
{
    InSequence s;
    std::vector<sptr<CameraDevice>> cameras = cameraManager->GetSupportedCameras();
 ...
 * CaseDescription: Test HCameraService with anomalous branch
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_005, TestSize.Level0)
{
    InSequence s;
    std::vector<sptr<CameraDevice>> cameras = cameraManager->GetSupportedCameras();
 ...
 * CaseDescription: Test HCameraService with anomalous branch
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_006, TestSize.Level0)
{
    InSequence s;
    std::vector<sptr<CameraDevice>> cameras = cameraManager->GetSupportedCameras();
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_007, TestSize.Level0)
{
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_008, TestSize.Level0)
{
 ...
 * CaseDescription: Test CaptureSession with no static capability.
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_009, TestSize.Level0)
{
    g_mockFlagWithoutAbt = true;
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_010, TestSize.Level0)
{
    g_mockFlagWithoutAbt = true;
    InSequence s;
    std::vector<sptr<CameraDevice>> cameras = cameraManager->GetSupportedCameras();
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_011, TestSize.Level0)
{
    g_mockFlagWithoutAbt = true;
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_012, TestSize.Level0)
{
    g_mockFlagWithoutAbt = true;
 ...
 * CaseDescription: Test HCaptureSession with anomalous branch.
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_013, TestSize.Level0)
{
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
 ...
 * CaseDescription: Test HCaptureSession with anomalous branch.
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_014, TestSize.Level0)
{
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
 ...
 * CaseDescription: Test HCaptureSession with anomalous branch.
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_015, TestSize.Level0)
{
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
 ...
 * CaseDescription: Test HCaptureSession with anomalous branch.
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_016, TestSize.Level0)
{
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
 ...
 * CaseDescription: Test HCaptureSession with anomalous branch.
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_017, TestSize.Level0)
{
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_018, TestSize.Level0)
{
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_019, TestSize.Level0)
{
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_020, TestSize.Level0)
{
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
 ...
 * CaseDescription: Test CaptureSession with anomalous branch.
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_021, TestSize.Level0)
{
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_022, TestSize.Level0)
{
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
 ...
 * CaseDescription: Test CaptureSession with anomalous branch.
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_023, TestSize.Level0)
{
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_024, TestSize.Level0)
{
 ...
 * CaseDescription: Test HCameraDevice with anomalous branch.
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_025, TestSize.Level0)
{
    std::vector<int32_t> result;
    result.push_back(OHOS_SENSOR_EXPOSURE_TIME);
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_026, TestSize.Level0)
{
    int32_t format = 0;
    int32_t width = 0;
    int32_t height = 0;
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_027, TestSize.Level0)
{
    int32_t format = 0;
 ...
 * CaseDescription: Test HStreamMetadata & HStreamCommon
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_028, TestSize.Level0)
{
    int32_t format = 0;
    std::string  dumpString ="HStreamMetadata";
    std::vector<sptr<CameraDevice>> cameras = cameraManager->GetSupportedCameras();
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_029, TestSize.Level0)
{
    int32_t format = 0;
    int32_t width = 0;
    int32_t height = 0;
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_030, TestSize.Level0)
{
    std::vector<int32_t> result;
    result.push_back(OHOS_SENSOR_EXPOSURE_TIME);
    result.push_back(OHOS_SENSOR_COLOR_CORRECTION_GAINS);
 ...
 */
HWTEST_F(CameraNdkUnitTest, camera_ndk_coverage_unittest_031, TestSize.Level0)
{
    InSequence s;
    EXPECT_CALL(*mockCameraHostManager, GetCameras(_));
    EXPECT_CALL(*mockCameraHostManager, GetCameraAbility(_, _)).Times(2);
