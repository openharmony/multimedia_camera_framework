...
#ifndef HSHARED_CAPTURE_SESSION_UNITTEST_H
#define HSHARED_CAPTURE_SESSION_UNITTEST_H
...
class HSharedCaptureSessionUnitTest : public testing::Test {
public:
...
#endif // HSHARED_CAPTURE_SESSION_UNITTEST_H