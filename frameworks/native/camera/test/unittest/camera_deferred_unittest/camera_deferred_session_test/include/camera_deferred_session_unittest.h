...
#ifndef CAMERA_DEFERRED_SESSION_UNITTEST_H
#define CAMERA_DEFERRED_SESSION_UNITTEST_H
...
class CameraDeferredSessionUnitTest : public testing::Test {
public:
...
#endif // CAMERA_DEFERRED_SESSION_UNITTEST_H
