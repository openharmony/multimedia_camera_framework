...
#ifndef MULTIMEDIA_CAMERA_FRAMEWORK_MASTER_SECURE_CAMERA_SESSION_FOR_SYS_H
#define MULTIMEDIA_CAMERA_FRAMEWORK_MASTER_SECURE_CAMERA_SESSION_FOR_SYS_H
...
#endif //MULTIMEDIA_CAMERA_FRAMEWORK_MASTER_SECURE_CAMERA_SESSION_FOR_SYS_H