...
class SlowMotionSession : public CaptureSessionForSys {
public:
    ...
    explicit SlowMotionSession(sptr<ICaptureSession> &slowMotionSession): CaptureSessionForSys(slowMotionSession)
    {
