...
#ifndef OHOS_CAMERA_EVENT_H
#define OHOS_CAMERA_EVENT_H
...
enum struct FilterEventType : uint32_t {
    EVENT_READY = 0,
...
enum struct DfxFilterEventType : uint32_t {
    DFX_INFO_START = 0,
...
struct DfxEvent {
    ...
    DfxFilterEventType type;
    Media::Any param;
};
} // namespace CameraStandard
} // namespace OHOS
#endif // OHOS_CAMERA_EVENT_H
