...
#ifndef VIDEO_ENCODER_FILTER_UNIT_TEST_H
#define VIDEO_ENCODER_FILTER_UNIT_TEST_H
...
class VideoEncoderFilterUnitTest : public testing::Test {
public:
    ...
    void TearDown(void);
private:
    std::shared_ptr<VideoEncoderFilter> videoEncoder_ {nullptr};
};
...
public:
    ...
    MockNextFilter() : CFilter("MockVidNextFilter", CFilterType::MUXER)
    {
