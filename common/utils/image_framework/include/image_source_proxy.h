...
#ifndef CAMERA_IMAGE_SOURCE_PROXY_H
#define CAMERA_IMAGE_SOURCE_PROXY_H
...
class ImageSourceProxy : public ImageSourceIntf {
public:
    explicit ImageSourceProxy(
...
private:
    ...
    std::shared_ptr<Dynamiclib> imageLib_ = {nullptr};
    std::shared_ptr<ImageSourceIntf> imageSourceIntf_ = {nullptr};
};
} // namespace CameraStandard
} // namespace OHOS
#endif // CAMERA_IMAGE_SOURCE_PROXY_H