...
#ifndef OHOS_CAMERA_MOVIE_FILE_ADAPTER_H
#define OHOS_CAMERA_MOVIE_FILE_ADAPTER_H
...
class MovieFileControllerBase;
class MovieFileAdapter : public MovieFileIntf {
public:
    MovieFileAdapter();
    virtual ~MovieFileAdapter() = default;
...
private:
    SpHolder<std::shared_ptr<MovieFileControllerBase>> movieFileController_;
};
} // namespace OHOS::CameraStandard
#endif // OHOS_CAMERA_MOVIE_FILE_ADAPTER_H