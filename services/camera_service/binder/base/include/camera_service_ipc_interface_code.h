...
enum CameraServiceInterfaceCode {
    ...
    CAMERA_SERVICE_IS_TORCH_SUPPORTED,
    CAMERA_SERVICE_IS_MUTE_SUPPORTED,
    ...
    CAMERA_SERVICE_MUTE_CAMERA_PERSIST,
    CAMERA_SERVICE_PROXY_FOR_FREEZE,
    ...
    CAMERA_SERVICE_REQUIRE_MEMORY_SIZE,
};
...
enum StreamCaptureInterfaceCode {
    ...
    CAMERA_STREAM_SET_BUFFER_PRODUCER_INFO,
    CAMERA_STREAM_SET_VIDEO_CODEC_TYPE,
    CAMERA_STREAM_ENABLE_RAW_DELIVERY,
    CAMERA_PHOTO_ROTATION,
    CAMERA_STREAM_ENABLE_MOVING_PHOTO,
    CAMERA_CAPTURE_DFX,
...
enum StreamRepeatInterfaceCode {
    ...
    CAMERA_STREAM_FRAME_RANGE_SET,
    CAMERA_ENABLE_SECURE_STREAM,
    CAMERA_ENABLE_STREAM_MIRROR,
    CAMERA_ATTACH_META_SURFACE,
    CAMERA_PRIVIEW_ROTATION,
    CAMERA_ENABLE_AUTO_FRAME_RATE,
    CAMERA_API_VERSION,
    CAMERA_GET_STREAM_MIRROR
};
