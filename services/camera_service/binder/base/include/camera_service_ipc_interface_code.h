...
enum class CameraDeviceInterfaceCode {
    ...
    CAMERA_DEVICE_UNSET_CALLBACK,
    CAMERA_DEVICE_OPEN_CONCURRENT,
    CAMERA_DEVICE_SET_DEVICE_RETRY_TIME,
};
...
enum CameraServiceInterfaceCode {
    ...
    CAMERA_SERVICE_RESET_RSS_PRIORITY,
    ...
    CAMERA_SERVICE_GETID_FOR_CONCURRENT,
    CAMERA_SERVICE_GET_CONCURRENT_CAMERA_ABILITY,
    CAMERA_SERVICE_GET_TORCH_STATUS,
    CAMERA_SERVICE_UNSET_CAMERA_CALLBACK,
    CAMERA_SERVICE_UNSET_MUTE_CALLBACK,
    CAMERA_SERVICE_UNSET_TORCH_CALLBACK,
    CAMERA_SERVICE_UNSET_FOLD_CALLBACK,
...
enum CaptureSessionInterfaceCode {
    ...
    CAMERA_CAPTURE_SESSION_SET_PRESSURE_CALLBACK,
    ...
    CAMERA_CAPTURE_SESSION_UNSET_PRESSURE_CALLBACK,
...
enum StreamRepeatInterfaceCode {
    ...
    CAMERA_STREAM_REPEAT_UNSET_CALLBACK,
};
...
enum StreamDepthDataInterfaceCode {
    ...
    CAMERA_STREAM_DEPTH_DATA_UNSET_CALLBACK,
};
...
enum CaptureSessionCallbackInterfaceCode {
    ...
    CAMERA_CAPTURE_SESSINO_PRESSURE_CALLBACK
};
} // namespace CameraStandard
} // namespace OHOS
