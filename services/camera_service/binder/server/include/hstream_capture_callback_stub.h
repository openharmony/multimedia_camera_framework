...
#ifndef OHOS_CAMERA_HSTREAM_CAPTURE_CALLBACK_STUB_H
#define OHOS_CAMERA_HSTREAM_CAPTURE_CALLBACK_STUB_H
...
class HStreamCaptureCallbackStub : public IRemoteStub<IStreamCaptureCallback> {
public:
